...
import { SCENE, wavePath } from './geometry';
...
export const Seascape = memo(function Seascape({ t }: { t: number }) {
    ...
    <G>
      <Defs>
        ...
        <LinearGradient id="sea" x1="0" y1="0" x2="0" y2="1">
          <Stop offset="0" stopColor="#2b5580" />
          <Stop offset="1" stopColor="#0e2540" />
        </LinearGradient>
        <LinearGradient id="moonGlow" x1="0" y1="0" x2="0" y2="1">
          <Stop offset="0" stopColor="#ffe8a3" stopOpacity="0.30" />
      ...
      <Circle cx={264} cy={26} r={16} fill="url(#moonGlow)" />
      <Circle cx={264} cy={26} r={8} fill="#ffe8a3" opacity={0.92} />
      <Circle cx={259} cy={23} r={6.5} fill="#1d3557" opacity={0.55} />
      ...
      <Rect x={256} y={horizonY} width={16} height={quayY - horizonY} fill="#ffe8a3" opacity={0.05} />
